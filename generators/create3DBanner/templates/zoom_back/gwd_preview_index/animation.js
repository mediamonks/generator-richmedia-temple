...
function getMainTimeline(obj) {
  ...
  tl.from(["#swipeIconSliderDot", "#swipeIconSliderDotRing"], 1.5, { x: -35, ease:Power2.easeInOut }, "logoOut+=0.5");
  tl.addLabel("swipe", "+=3");
  tl.to(["#swipeIconSliderDot", "#swipeIconSliderDotRing"], 1.5, { x: -53, ease:Power2.easeInOut });
  tl.to(["#swipeIconSliderDot", "#swipeIconSliderDotRing"], 1.5, { x: -2, ease:Power2.easeInOut });
  tl.to(["#swipeIconSliderDot", "#swipeIconSliderDotRing"], 1.5, { x: -53, ease:Power2.easeInOut });
  tl.to(["#swipeIconSliderDot", "#swipeIconSliderDotRing"], 1.5, { x: -2, ease:Power2.easeInOut });
  tl.to(["#swipeIconSlider", "#swipeIconSliderDot", "#swipeIconSliderDotRing"], 0.2, { opacity: 0, ease: Power0.easeIn }, "swipe");
...
function getExpandTimeline() {
  ...
  tl.fromTo(["#doorRight", "#doorLogo"], 3, { x: 0 }, { x: document.querySelector("#doorRight").offsetWidth }, "openDoors+=1");
...
function getPulseTL() {
  ...
  tl.staggerFromTo(window.settings.hotspots.hotspotRings, 1.3,{ scale: 0 }, { scale: 1 }, 0.2, 'pulse');
  tl.staggerFromTo(window.settings.hotspots.hotspotRings, 0.8,{ autoAlpha: 0 }, { autoAlpha: 1 }, 0.2, 'pulse+=0.5');
  tl.staggerTo(window.settings.hotspots.hotspotRings, 1.2,{ autoAlpha: 0 }, 0.2, 'pulse+=1.2');
...
function getHotspotTL() {
  var tl = new TimelineMax({
    paused: true,
    onStart: function() {
      window.pulseTL = getPulseTL();
      window.pulseTL.play(0);
    }
  });

  tl.staggerFromTo([window.settings.hotspots.hotspots,'#tap-to-discover-copy'], 0.25, { autoAlpha: 0, scale: 0.6 }, { autoAlpha: 1, scale: 1 }, 0.1);
